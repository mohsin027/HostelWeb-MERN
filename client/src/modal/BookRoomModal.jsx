...
// export default function BookRoomModal({hostelId,open, setOpen}) {
//   //
...
//     try {
//       const { data: responseData } = await axios.post("/hostel/hostel/addRooms", {
//         ...data,hostelId
//       });
...
//       setOpen(false)
//       console.log("succesfully added room");
//       setData({
//         room_no: "",
//         room_type: "",
//         capacity: "",
...
//                 Close
//               </MDBBtn>
//               <MDBBtn  type='submit' disabled={isNotValidForm()}>Save</MDBBtn>
//             </MDBModalFooter>
//             </Form>
//           </MDBModalContent>
//         </MDBModalDialog>
